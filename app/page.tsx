    ...
    <main className="min-h-screen bg-[var(--paper)] text-[var(--ink)]">
      <section className="album-hero">
        ...
        <div className="hero-copy">
          ...
          <h1>Наш альбом, в котором собраны самые тёплые моменты</h1>
          <p>
        ...
        <div className="secret-modal-backdrop" role="presentation" onClick={() => setIsEasterEggOpen(false)}>
          ...
          >
            ...
            <p>
              ...
              вселенная разлетелась бы в разные стороны, и не было бы ни звёзд,
            ...
            <p>
              На нашей планете 8 миллиардов человек, а мне попалась идеальная
